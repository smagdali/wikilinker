...
Auto-links proper nouns and entities to Wikipedia on news sites

## Chrome Web Store — Detailed description

Wikilinker automatically adds Wikipedia links to the people, places, organizations, and other notable entities mentioned in news articles. Each entity is linked only on its first occurrence, keeping the reading experience clean.
